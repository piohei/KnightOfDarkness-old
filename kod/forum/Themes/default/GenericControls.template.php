...
function template_control_richedit($editor_id, $smileyContainer = null, $bbcContainer = null)
{
	...
	echo '
		<div>
			...
			<div id="', $editor_id, '_resizer" style="display: none; ', $context['browser']['is_ie8'] ? 'max-width: ' . $editor_context['width'] . '; min-width: ' . $editor_context['width'] : 'width: ' . $editor_context['width'], '; padding: 0 2px;" class="richedit_resize"></div>
		</div>
