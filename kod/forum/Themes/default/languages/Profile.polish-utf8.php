...
$txt['max_sig_characters'] = 'Maksymalnie: %1$d; pozostało znaków: ';
...
$txt['password_reminder_desc'] = 'Jeśli zapomniałeś swojego loginu lub hasła, nie przejmuj się, możesz je odzyskać. Aby rozpocząć proces odzyskiwania danych logowania, wpisz poniżej nazwę użytkownika lub hasło.';
...
$txt['notify_send_body'] = 'Gdy będziesz wysyłał powiadamianie o odpowiedzi na wątek, wysyłaj treść wiadomości w poczcie elektronicznej (ale proszę nie odpowiadać na tego e-mail\'a.)';
...
$txt['activate_changed_email'] = 'Zmieniłeś swój adres email. Dostaniesz wkrótce list, aby go zatwierdzić. Kliknij na odnośnik aby reaktywować swoje konto.';
...
$txt['wysiwyg_default'] = 'Domyślnie pokaż edytor WYSIWYG gdy piszesz nową  lub edytujesz wiadomość.';
...
$txt['username_warning'] = 'Aby zmienić nazwę tego użytkownika, forum musi również resetować jego hasło. Zostanie ono do niego wysłane, wraz z nową nazwą użytkownika.';
...
$txt['profile_error_signature_max_font_size'] = 'Tekst w Twoim podpisie nie może być większy niż %1$d pikseli';
$txt['profile_error_signature_max_smileys'] = 'Nie wolno Ci użyć więcej niż %1$d emotikon w Twoim podpisie';
$txt['profile_error_signature_disabled_bbc'] = 'Następujący tag BBC nie jest dozwolony w Twoim podpisie: %1$d';
...
$txt['profile_warning_issue'] = 'Przyznaj Ostrzeżenie';
...
$txt['email_notify'] = 'Powiadom przez email, kiedy otrzymujesz prywatną wiadomość:';
...
$txt['pm_receive_from_admins'] = 'Tylko administratorów';
...
$txt['pm_remove_inbox_label'] = 'Oznaczając etykietą, usuń etykietę odebranych.';
