...
Twoje konto na {FORUMNAME} zostało usunięte. Prawdopodbna przyczyna: Nie aktywowałeś swojego konta po rejstracji. Jeśli chcesz korzystać z forum, musisz powtórzyć proces rejestracji.
...
'body' => 'Żeby ponownie zatwierdzić Twój adres email, konto zostało zdeaktywowane. Kliknij na poniższy link, aby ponownie aktywować swoje konto:
{ACTIVATIONLINK}
...
Zanim będziesz mógł się zalogować, najpierw musisz aktywować swoje kontio. Aby to zrobić, użyj poniższego linku:
...
Zanim będziesz mógł się zalogować, administrator poporosi Twoich rodziców/opiekunów o zgodę na Twoje uczestnictwo w społeczności forum. Więcej informacji uzyskasz pod tym adresem:
...
'body' => 'Dziękujemy za zarjestrowanie się na {FORUMNAME}. Twója nazwa użytkownika to {USERNAME}. Jeśli zapomniałeś swojego hasła możesz je zmienić w {FORGOTPASSWORDLINK}.
...
'body' => '{POSTERNAME} napisał odpowiedź w wąteku, który śledzisz.
...
'body' => '{USERNAME} właśnie zarejestrował się na Twoim forum. Kliknij w adres poniżej, aby obejrzeć jego profil.
{PROFILELINK}
...
'subject' => 'Dołączył nowy uzytkownik',
...
Kiedy folder załączników osiagnie swój maksymalny rozmiar, użytkownicy nie będą mogli dodawać załączników do postów i ładować nowych awatarów (Jeśli ta opcja jest aktywna).
...
Użytkownik wybrał nową płatną subskrypcję. Poniżej znadziesz szczegoły:
...
{REGARDS}',
	...
	'karlbenson1' => array(
		...
		'body' => 'Moglismy wysłać Ci kartkę urodzinową. Mogliśmy wysłać Ci bukiet kwiatów lub tort.
...
Napisaliśmy te Seredeczne Życzenia Urodzinowe dokładnie dla Ciebie! 
