...
$txt['admin_censored_desc'] = 'Z uwagi na publiczny charakter forum, mogą istnieć słowa, których wysyłania chcesz zabronić swoim użytkownikom. Pod spodem możesz wprowadzić słowa, które mają być ocenzurowane przy każdym użyciu przez któregoś z <br />Wyczyść pole aby usunąć dane słowo.';
...
$txt['admin_agreement_default'] = 'Standardowy';
$txt['admin_agreement_select_language'] = 'Język edycji';
...
$txt['admin_main_welcome'] = 'To jest "%s". Tu możesz modyfikować ustawienia, obsługiwać forum, przeglądać raporty, instalować pakiety, zarządzać stylami i robić wiele innych rzeczy.<div style="margin-top: 1ex;">Jeśli masz jakiekolwiek problemy, zajrzyj do działu "najczęstsze pytania". Jeśli zawarte tam informacje nie pomogą Ci, <a href="http://www.simplemachines.org/community/index.php" target="_blank">zwróć się po pomoc do nas</a>.</div>Odpowiedzi na twoje pytania i rozwiązania problemów możesz również znaleźć klikając na ikonę <img src="' . $settings['images_url'] . '/helptopics.gif" alt="%s" title="%s" border="0" /> umieszczoną przy danych opcjach.<br /><br />Autorzy polonizacji SMF: Nolt, ronin, Kemac, CyPhErR, tommass, HaWaN i WilK.<br />Wszelkie zauważone błędy proszę zgłaszać na <a href="http://www.smf.pl">www.smf.pl (Polska Pomoc Simple Machines Forum)</a>.';
...
$txt['attachment_integrity_check_desc'] = 'Ta funkcja sprawdzi oraz jeśli będzie to konieczne naprawi błędy związane ze spójnością i rozmiarem załączników a także lista ich nazw w bazie danych.';
...
$txt['version_check_desc'] = 'Informacja pokazuje wersję twoich plików instalacyjnych przeciwko najnowszym plikom. Jeśli któryś z plików jest nieaktualny, powinieneć pobrać i zaktualizować je do najnowszej wersji <a href="http://www.simplemachines.org/" target="_blank" class="new_win">www.simplemachines.org</a>.';
...
$txt['ban_trigger_browse_description'] = 'Ten ekran pokazuje wszystkie zbanowane wpisy pogrupowane wg adresu IP, nazwy hosta, adresu email i nazwy użytkownika.';

$txt['ban_log'] = 'Rejestr';
$txt['ban_log_description'] = 'Rejestr pokazuje wszystkie próby wejścia na forum dokonane przez banowanych użytkowników (dot. tylko: \'pełnego bana\' i \'zakazu rejestracji\').';
...
$txt['support_credits_title'] = 'O SMF...';
...
$txt['permitgroups_maintenance'] = 'Obsługa forum';
...
$txt['attachment_manager_total_avatars'] = 'Awatary w sumie';

$txt['attachment_manager_avatars_no_entries'] = 'Nie ma obecnie żadnych avatarów';
...
$txt['attach_path_manage'] = 'Zarządzaj scięzką załączników';
...
$txt['custom_avatar_dir'] = 'Katalog upload\'u';
$txt['custom_avatar_dir_desc'] = 'To powinien być inny katalog, niż katalog główny serwera.';
$txt['custom_avatar_url'] = 'URL upload\'u';
...
$txt['repair_attachments_continue'] = 'Napraw';
...
$txt['manageposts_bbc_settings_description'] = 'Znaczniki Bulletin Board Code mogą być używane do formatowania tekstu wiadomości. Na przykład aby wytłuścić słowo \'dom\' wpisz [b]dom[\\b]. Wszystkie znaczniki BBC są umieszczane wewnątrz nawiasów kwadratowych (\'[\' and \']\').';
...
$txt['load_balancing_settings'] = 'Załaduj zbalansowane';
...
$txt['copyright_ends_in'] = 'Kod usuwający stopkę wygasa za <strong>%1$s</strong> dni.';
$txt['copyright_click_renew'] = 'Kliknij <a href="http://www.simplemachines.org/copyright/renew.php?key=%1$s" class="alert">tutaj</a> aby odnowić';
$txt['copyright_removal'] = 'Usunięcie stopki';
$txt['copyright_removal_desc'] = 'Aby usunąć stopkę z SMF należy posiadać kod zakupiony na stronie Simple Machines. Jeśli nie zamówiłeś kodu, kliknij <a href="http://www.simplemachines.org/copyright/index.php">tu</a>. Jak tylko kod zostanie wprowadzony i zweryfikowany, stopka zostanie ukryta. Pozostały czas będzie widoczny w Centrum administracji.';
$txt['copyright_code'] = 'Kod';
$txt['copyright_proceed'] = 'Dalej';
