...
$txt['no_password'] = 'Pole hasła puste';
...
$txt['email_in_use'] = 'Podany adres email (%1$s) jest używany przez innego zarejestrowanego użytkownika. Jeśli to pomyłka, idź do strony z logowaniem i postaraj się przywrócić hasło na ten adres email.';
...
$txt['copyright_failed'] = 'Przepraszamy - kod, który wpisałeś jest niepoprawny. Upewnij się, że URL twojego forum zgadza się z tym, który wpisałeś wykupując subskrypcje.';
...
$txt['invalid_email'] = 'Nieprawidłowy adres email lub zakres adresów.<br />Przykład prawidłowego adresu: bill.gates@microsoft.com.<br />Przykład prawidłowego zakresu adresów: *@*.microsoft.com';
$txt['invalid_expiration_date'] = 'Nieprawidłowa data wygaśnięcia';
$txt['invalid_hostname'] = 'Nieprawidłowa nazwa dostawcy lub zakres nazw<br />Przykład prawidłowej nazwy: proxy4.microsoft.com<br />Przykład prawidłowego zakresu nazw: *.microsoft.com';
...
$txt['error_search_string_small_words'] = 'Każe słowo musi składać się przynajmniej z dwóch znaków.';
...
$txt['profile_error_password_short'] = 'Twoje hasło musi mieć co najmniej ' . (empty($modSettings['password_strength']) ? 4 : 8) . ' znaków(i) długości.';
